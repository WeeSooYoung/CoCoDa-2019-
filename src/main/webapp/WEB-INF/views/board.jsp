				...
				<div class="col-md-12">
                          ...
                          <div class="card card-default" id="user-activity">
                            <div class="row no-gutters">
                              ...
                              <div class="card-body">
                               <c:if test="${sessionScope.userid != null }">
										<input type="button" value="글쓰기" onClick="location.href='towrite';" class="mb-1 btn btn-info" style="float:right;">
								</c:if>
                              <table class="table">
							    ...
							    <tbody> 
									...
									<tr><td class="boardnum"  style="text-align:center; color:gray;">${item.boardnum}</td>
							    	<td class="title"><a href="readingEachBoard?boardnum=${item.boardnum }">${item.title}</a></td> 
							    	<td class="id"  style="text-align:center;">${item.id }</td>
							    	<td class="hits"  style="text-align:center;">${item.hits }</td>
							    	<td class="inputdate"  style="text-align:center;">${item.inputdate }</td></tr>
							  		</c:forEach>
							    	</tbody>				    	
							</table>							
								<!-- here -->
								...
								<div class="navigatorbox">
									...
									<form id="pagingForm" method="get" action="boardPage">
