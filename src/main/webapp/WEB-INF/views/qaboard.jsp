                                ...
                                <div class="border-right">
                                 ...
                                 <!-- 여기 -->
                                  <div class="card-body">
                                       		...
                                       		<c:if test="${sessionScope.userloginId != null }">
													<input type="button" value="글쓰기" onClick="location.href='qatowrite';" class="mb-1 btn btn-info" style="float:right;">
												</c:if>
                                    	...
                                    	<table class="table">
										    ...
										    <tbody> 
										    	...
										    	<td class="title"><a href="qareadingEachBoard?boardnum=${item.boardnum }">${item.title}</a></td> 
											...
											<div class="navigatorbox">
												...
												<form id="pagingForm" method="get" action="qaboardPage">
													<input type="hidden" name="page" id="page"></br>
													<!-- 제목 : -->
													<input type="text" name="searchText" value="${searchText}" style="height:40px; width:350px;" />
