          ...
          <div class="card">
            ...
            <div class="card-body p-5">
              ...
              <h4 class="text-dark mb-5">Sign In</h4>
                ...
                <form id="userr" action="userlogin" method="post">
	                  <div class="form-group col-md-12 mb-4">
	                    <input type="text" class="form-control input-lg" name="userid" placeholder="Username">
	                  </div>
	                  <div class="form-group col-md-12 ">
	                    <input type="password" class="form-control input-lg" name="userpw" placeholder="Password">
	                  </div>
	                  	<!-- <button type="submit" class="btn btn-lg btn-primary btn-block mb-4" id ="userloginbtn">Sign In</button> -->
	                  	 <input class="btn btn-lg btn-primary btn-block mb-4" id ="userloginbtn" type="button" onclick="loginRequest()" value="Sign In"/> 
	              </form>
